...
<<<<<<< HEAD
    ...
    path('messaging/<uuid:message_id>/restore/', views.restore_message, name='restore_message'),
    path('messaging/<uuid:message_id>/permanently-delete/', views.permanently_delete_message, name='permanently_delete_message'),
    path('messaging/<uuid:message_id>/responses/', views.message_responses, name='message_responses'),
    path('messaging/responses/<int:response_id>/delete/', views.delete_message_response, name='delete_message_response'),
    path('messaging/responses/<int:response_id>/restore/', views.restore_message_response, name='restore_message_response'),
    path('messaging/responses/<int:response_id>/permanently-delete/', views.permanently_delete_message_response, name='permanently_delete_message_response'),
...
<<<<<<< HEAD
    ...
    path('attendance/<int:attendance_id>/restore/', views.restore_attendance, name='restore_attendance'),
